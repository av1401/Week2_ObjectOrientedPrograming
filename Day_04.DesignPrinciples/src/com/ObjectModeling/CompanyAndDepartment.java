...
public class CompanyAndDepartment {
    public static void main(String[] args) {
        // Create a company
        Company company = new Company("ABCD");
        ...
        itDepartment.addEmployee(new Employee("Shiv", "Software Engineer",56000));

        // Add employees to HR department
        hrDepartment.addEmployee(new Employee("Narayan","Manager",56000));
