...
public class UniversityManagement {
    public static void main(String[] args) {
        ...
        Faculty Sanyal = new Faculty("Chandana Sanyal", "Social Studies");
        Faculty Preeti = new Faculty("Preeti Shrivastava", "Python");
        // Create departments
        ...
        csDepartment.addFaculty(Sanyal);
        aimlDepartment.addFaculty(Preeti);
