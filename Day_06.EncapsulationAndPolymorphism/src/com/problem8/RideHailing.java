...
public class RideHailing {
    public static void main(String[] args) {
        ...
        Vehicle car = new Car("C101", "Naved Bhaiya", 15.0, "Gouharganj");
        Vehicle bike = new Bike("B202", "Chacha", 10.0, "Mandiddep");
        Vehicle auto = new Auto("A303", "Ramprakash", 12.0, "Bhopal");
