...
// Absract and Superclass : Product
...
public class ECommercePlatform {
    public static void main(String[] args) {
        ...
        Product electronicItem = new Electronics("E01", "Television", 10000, 12, 18);
        Product clothingItem = new Clothing("C01", "Pant", 1000, 8, 5);
        Product groceryItem = new Groceries("G01", "Wheat Flour", 100, 6, 3);
