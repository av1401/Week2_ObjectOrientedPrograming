...
public class LibraryAndBooks {
    public static void main(String... args) {
        ...
        Book book1 = new Book("Anter Mantar", "Abhishek Vishwakarma");
        Book book2 = new Book("Jaadu kalantar", "Abhishek Sharma");
        Book book3 = new Book("Husa Busa", "Sahil Ganeshwani");
        Book book4 = new Book("Boo", "Swayam Verma");
