...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        FullTimeEmployee fullTimeEmployee = new FullTimeEmployee("A007", "Abhishek", 150000);
        fullTimeEmployee.assignDepartment("IT");
        employees.add(fullTimeEmployee);

        PartTimeEmployee partTimeEmployee = new PartTimeEmployee("A001", "Swayam", 0, 208, 500);
