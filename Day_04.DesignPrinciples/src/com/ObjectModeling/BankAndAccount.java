...
class Bank {
    private static long accountNumberGenerator = 123456789; // Static variable to generate unique account numbers
...
public class BankAndAccount {
    public static void main(String... args) {
        ...
        Customer customer1 = new Customer("Abhishek", "Saving");
        Customer customer2 = new Customer("Swayam", "Current");
        Customer customer3 = new Customer("Mansi", "Business");
        Customer customer4 = new Customer("Sahil", "Saving");

        // Create a Bank object
        Bank Axis = new Bank();

        // Open accounts for the customers in the bank
        Axis.openAccount(customer1);
        Axis.openAccount(customer2);
        Axis.openAccount(customer3);
        Axis.openAccount(customer4);
